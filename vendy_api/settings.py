"""
Django settings for vendy_api project.
...
SECRET_KEY = 'ixc0exr%r0dguimadj#!^qn4ty+d&^tjuu+8a(g0qe@#+igw23'
...
# AWS_SECRET_ACCESS_KEY = removed due to security issues
# AWS_STORAGE_BUCKET_NAME = removed due to security issues
